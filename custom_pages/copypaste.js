...
class AssignmentListWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    ...
    checkNbGraderVersion() {
        ...
        (0,_assignmentlist__WEBPACK_IMPORTED_MODULE_2__.requestAPI)('nbgrader_version?version=' + "0.9.5")
            .then(response => {
            if (!response['success']) {
...
const assignmentListExtension = {
    ...
    activate: (app, restorer, notebookTree) => {
        ...
        console.debug('JupyterLab extension assignment-list is activated!123');
    }
};
/**
 * Courses list plugin.
...
//# sourceMappingURL=lib_course_list_courselist_js-lib_course_list_index_js-lib_index_js.ef460783d34f84153eeb.js.map
